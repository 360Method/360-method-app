...
const TOUR_STEPS = {
  struggling: [
    ...
    { id: 'baseline', title: 'Step 1: Baseline', description: "Document your 6 systems - most are flagged or urgent.", page: 'Baseline', icon: ClipboardList },
    { id: 'inspect', title: 'Step 2: Inspect', description: "7 issues found - 2 critical, 2 urgent, 3 high priority.", page: 'Inspect', icon: ScanSearch },
    { id: 'prioritize', title: 'Step 4: Prioritize', description: "AI ranks by urgency. CO detectors first - do TODAY.", page: 'Prioritize', icon: ListChecks },
    { id: 'schedule', title: 'Step 5: Schedule', description: "Plan maintenance strategically to save time and money.", page: 'DemoSchedule', icon: Calendar },
    { id: 'execute', title: 'Step 6: Execute', description: "$2,650 now prevents $22,350 in emergencies.", page: 'DemoExecute', icon: Wrench },
    { id: 'preserve', title: 'Step 7: Preserve', description: "$2,050 extends dying systems 3+ years.", page: 'Preserve', icon: Shield },
    { id: 'upgrade', title: 'Step 8: Upgrade', description: "First upgrade: CO detectors. $100 for life safety.", page: 'Upgrade', icon: TrendingUp },
  ...
  improving: [
    ...
    { id: 'baseline', title: 'Step 1: Baseline', description: "6 systems documented. Water heater needs attention.", page: 'Baseline', icon: ClipboardList },
    { id: 'inspect', title: 'Step 2: Inspect', description: "Fall inspection found 2 issues. Catching problems early.", page: 'Inspect', icon: ScanSearch },
    { id: 'prioritize', title: 'Step 4: Prioritize', description: "4 tasks - crawlspace vapor barrier is high priority.", page: 'Prioritize', icon: ListChecks },
    { id: 'schedule', title: 'Step 5: Schedule', description: "Plan maintenance strategically to save time and money.", page: 'DemoSchedule', icon: Calendar },
    { id: 'execute', title: 'Step 6: Execute', description: "HVAC service scheduled. Preventing, not firefighting.", page: 'DemoExecute', icon: Wrench },
    { id: 'preserve', title: 'Step 7: Preserve', description: "$1,910 extends 3 systems 3-6 years.", page: 'Preserve', icon: Shield },
    { id: 'upgrade', title: 'Step 8: Upgrade', description: "Smart thermostat + leak detectors: $420, 1.5yr payback.", page: 'Upgrade', icon: TrendingUp },
  ...
  excellent: [
    ...
    { id: 'baseline', title: 'Step 1: Baseline', description: "16 systems with photos, warranties, history.", page: 'Baseline', icon: ClipboardList },
    { id: 'inspect', title: 'Step 2: Inspect', description: "4 quarterly inspections. Issues cleared immediately.", page: 'Inspect', icon: ScanSearch },
    { id: 'track', title: 'Step 3: Track', description: "16 maintenance events logged this year.", page: 'Track', icon: BarChart3 },
    { id: 'schedule', title: 'Step 5: Schedule', description: "All tasks scheduled strategically throughout the year.", page: 'DemoSchedule', icon: Calendar },
    { id: 'execute', title: 'Step 6: Execute', description: "Routine tasks only. No emergencies, just rhythm.", page: 'DemoExecute', icon: Wrench },
    { id: 'preserve', title: 'Step 7: Preserve', description: "$2,825/year avoids $24,700 replacements.", page: 'Preserve', icon: Shield },
    { id: 'upgrade', title: 'Step 8: Upgrade', description: "Surge protection done. Adding Flo monitoring.", page: 'Upgrade', icon: TrendingUp },
    { id: 'scale', title: 'Step 9: Scale', description: "$550K property, $250K equity. Growing wealth.", page: 'Scale', icon: Building2 },
  ...
  investor: [
    ...
    { id: 'dashboard', title: 'Dashboard', description: "All properties: scores 97, 78, 62. $3,170/mo flow.", page: 'DashboardInvestor', icon: Building2 },
    { id: 'properties', title: 'Properties', description: "Duplex (97), Single-family (78), Triplex (62).", page: 'Properties', icon: Home },
    { id: 'prioritize', title: 'Prioritize', description: "All tasks ranked. Triplex has critical issues.", page: 'Prioritize', icon: ListChecks },
    { id: 'schedule', title: 'Schedule', description: "Plan maintenance across your entire portfolio.", page: 'DemoSchedule', icon: Calendar },
    { id: 'execute', title: 'Execute', description: "Assign contractors, track progress across portfolio.", page: 'DemoExecute', icon: Wrench },
    { id: 'scale', title: 'Scale', description: "$547K equity, 17.8% ROI. 10-year: $1.8M.", page: 'Scale', icon: TrendingUp },
