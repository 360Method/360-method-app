...
export default function FloatingSignupCTA() {
  ...
  // Only show on actual demo pages
  useEffect(() => {
  ...
  if (isMinimized) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-[45] bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-4 rounded-full shadow-2xl hover:shadow-orange-500/50 active:scale-95 transition-all flex items-center gap-2 font-bold md:right-6"
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[45] bg-gradient-to-r from-orange-500 via-orange-600 to-pink-600 text-white shadow-2xl border-t-4 border-white/30 md:left-64">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-base sm:text-lg leading-tight">
                  Ready to Protect Your Own Property?
                </h3>
