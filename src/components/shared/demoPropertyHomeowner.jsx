export const DEMO_PROPERTY_HOMEOWNER = {
  ...
  tasks: [
    ...
    },
    {
      ...
      contractor_name: 'Reliable Plumbing Co',
    ...
    },
    {
      id: 'demo-h-task-009',
      property_id: 'demo-homeowner-001',
      title: 'Dryer Vent Deep Cleaning',
      description: 'Dryer vent has lint buildup reducing efficiency and creating fire hazard. Professional cleaning recommended.',
      system_type: 'Appliances',
      priority: 'High',
      cascade_risk_score: 9,
      cascade_risk_reason: 'FIRE HAZARD - Lint buildup is leading cause of dryer fires (15,000+ annually)',
      current_fix_cost: 150,
      delayed_fix_cost: 50000,
      cost_impact_reason: 'House fire could result in total loss',
      urgency_timeline: 'Within 2 weeks',
      diy_cost: 75,
      diy_difficulty: 'Medium',
      diy_time_hours: 2,
      ...
      status: 'Identified',
      source: 'INSPECTION',
      has_cascade_alert: true,
      created_date: '2025-10-15T00:00:00Z'
    },
    {
      id: 'demo-h-task-010',
      property_id: 'demo-homeowner-001',
      title: 'Seal Basement Floor Cracks',
      description: '3 hairline cracks in basement floor allowing moisture. Seal now to prevent widening and water infiltration.',
      system_type: 'Foundation',
      priority: 'Medium',
      cascade_risk_score: 6,
      cascade_risk_reason: 'Cracks can widen during freeze/thaw, leading to water infiltration',
      current_fix_cost: 200,
      delayed_fix_cost: 3500,
      cost_impact_reason: 'Widening cracks require professional epoxy injection or underpinning',
      urgency_timeline: 'Before winter freeze',
      diy_cost: 80,
      diy_difficulty: 'Easy',
      diy_time_hours: 1.5,
      contractor_cost: 250,
    ...
    },
    {
      id: 'demo-h-task-011',
      property_id: 'demo-homeowner-001',
      title: 'Furnace Filter Replacement (Quarterly)',
      description: 'Replace HVAC filter every 3 months to maintain efficiency and air quality.',
      system_type: 'HVAC',
      priority: 'Routine',
      cascade_risk_score: 5,
      cascade_risk_reason: 'Dirty filters reduce efficiency and can damage blower motor',
      current_fix_cost: 25,
      delayed_fix_cost: 800,
      cost_impact_reason: 'Clogged filter can burn out blower motor',
      urgency_timeline: 'Every 3 months',
      diy_cost: 25,
      diy_difficulty: 'Easy',
      diy_time_hours: 0.25,
      contractor_cost: 75,
    ...
    },
    {
      id: 'demo-h-task-012',
      property_id: 'demo-homeowner-001',
      title: 'Garage Door Opener Safety Sensor Realignment',
      description: 'Safety sensors slightly misaligned causing door reversals. Quick DIY fix prevents potential safety issues.',
      system_type: 'Garage & Overhead Door',
      priority: 'Medium',
      cascade_risk_score: 7,
      cascade_risk_reason: 'Malfunctioning sensors could fail to detect person/object, causing injury',
      current_fix_cost: 0,
      delayed_fix_cost: 500,
      cost_impact_reason: 'Could require professional recalibration or sensor replacement',
      urgency_timeline: 'This weekend',
      diy_cost: 0,
      diy_difficulty: 'Easy',
      diy_time_hours: 0.5,
      contractor_cost: 150,
    ...
    },
    {
      id: 'demo-h-task-013',
      property_id: 'demo-homeowner-001',
      title: 'Weatherstrip Front & Back Doors',
      description: 'Door weatherstripping worn, creating drafts. Replace before heating season to improve efficiency.',
      system_type: 'Windows/Doors',
      priority: 'Medium',
      cascade_risk_score: 3,
      cascade_risk_reason: 'Drafts increase heating costs and reduce comfort',
      current_fix_cost: 60,
      delayed_fix_cost: 60,
      urgency_timeline: 'Before heating season',
      diy_cost: 60,
      diy_difficulty: 'Easy',
      diy_time_hours: 1,
      contractor_cost: 200,
    ...
    },
    {
      id: 'demo-h-task-014',
      property_id: 'demo-homeowner-001',
      title: 'Test & Document All GFCI Outlets',
      description: 'Monthly GFCI testing in kitchen, bathrooms, garage. Ensures electrical safety.',
      system_type: 'Electrical',
      priority: 'Routine',
      cascade_risk_score: 8,
      cascade_risk_reason: 'Failed GFCI could result in electrical shock in wet areas',
      current_fix_cost: 0,
      delayed_fix_cost: 0,
      urgency_timeline: 'Monthly',
      diy_cost: 0,
      diy_difficulty: 'Easy',
      diy_time_hours: 0.25,
      status: 'Identified',
      source: 'SEASONAL_CHECKLIST',
      seasonal: true,
      recommended_completion_window: 'Monthly',
      created_date: '2025-10-15T00:00:00Z'
    }
  ],
