...
export const DEMO_PORTFOLIO_INVESTOR = {
  ...
  tasks: [
    ...
    },
    {
      ...
      description: 'Seal deck to prevent wood rot and extend life.',
      priority: 'Medium',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(20),
    ...
    },
    {
      ...
      description: 'Replace air filter for optimal efficiency.',
      priority: 'Routine',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(13),
      current_fix_cost: 25,
      cascade_risk_score: 2,
      system_type: 'HVAC',
      source: 'SEASONAL_CHECKLIST',
    ...
    },
    {
      id: 'sched-4',
      property_id: 'demo-investor-1',
      title: 'Caulk repair around bathtub - Unit A',
      description: 'Re-caulk bathtub to prevent water damage.',
      priority: 'Low',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(28),
      current_fix_cost: 85,
      cascade_risk_score: 3,
      system_type: 'Plumbing',
      source: 'INSPECTION',
    ...
    // PROPERTY 2: OAK RIDGE - Scheduled
    {
      id: 'inv-task-6',
      property_id: 'demo-investor-2',
    ...
    },
    {
      ...
      priority: 'Routine',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(15),
    ...
    },
    {
      ...
      priority: 'Routine',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(25),
      current_fix_cost: 30,
      cascade_risk_score: 2,
      system_type: 'General',
      source: 'SEASONAL_CHECKLIST',
    ...
    },
    {
      ...
      description: 'Annual chimney inspection for safety.',
      priority: 'Routine',
      status: 'Scheduled',
    ...
    },
    {
      ...
      description: 'Prevent fire hazard and improve efficiency.',
      priority: 'Medium',
      status: 'Scheduled',
    ...
    },
    {
      ...
      description: 'Flush sediment to extend water heater life.',
      priority: 'Routine',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(45),
    ...
    },
    {
      ...
      description: 'Protect deck from weather damage.',
      priority: 'Medium',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(65),
      current_fix_cost: 550,
      cascade_risk_score: 4,
      system_type: 'Exterior',
      source: 'SEASONAL_CHECKLIST',
      contractor_cost: 550,
    ...
    // PROPERTY 3: CEDAR COURT 4-PLEX - Scheduled
    {
      id: 'inv-task-11',
      property_id: 'demo-investor-3',
    ...
    },
    {
      ...
      description: 'Clean gutters before winter rains.',
      priority: 'Routine',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(15),
      current_fix_cost: 250,
    ...
    },
    {
      id: 'sched-10',
      property_id: 'demo-investor-3',
      title: 'Dryer vent cleaning - shared laundry',
      description: 'Prevent fire hazard in shared laundry.',
      priority: 'High',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(18),
      current_fix_cost: 125,
    ...
    },
    {
      id: 'sched-11',
      property_id: 'demo-investor-3',
      title: 'Unit 2C ceiling repair - water stain',
      description: 'Repair ceiling damage from roof leak.',
      priority: 'High',
      status: 'Scheduled',
      scheduled_date: getDemoFutureDate(25),
      current_fix_cost: 450,
    ...
    },
    {
      ...
      description: 'Inspect and re-caulk windows as needed.',
      priority: 'Low',
      status: 'Identified',
      current_fix_cost: 120,
      cascade_risk_score: 2,
    ...
    },
    {
      ...
      description: 'Remove mildew and dirt from siding.',
      priority: 'Low',
      status: 'Identified',
      current_fix_cost: 250,
      cascade_risk_score: 1,
    ...
    },
    {
      ...
      description: 'Test sump pump before rainy season.',
      priority: 'Medium',
      status: 'Identified',
      current_fix_cost: 0,
    ...
    },
    {
      ...
      description: 'Trim branches to prevent roof damage.',
      priority: 'Medium',
      status: 'Identified',
      current_fix_cost: 450,
      cascade_risk_score: 5,
    ...
    },
    {
      ...
      description: 'Service garage door opener for smooth operation.',
      priority: 'Low',
      status: 'Identified',
      current_fix_cost: 120,
      cascade_risk_score: 2,
    ...
    },
    {
      ...
      description: 'Stain fence to protect wood and improve appearance.',
      priority: 'Low',
      status: 'Identified',
      current_fix_cost: 850,
      cascade_risk_score: 2,
    ...
    },
    {
      ...
      description: 'Inspect crawl space for moisture and mold.',
      priority: 'Medium',
      status: 'Identified',
      current_fix_cost: 75,
      cascade_risk_score: 6,
    ...
    },
    {
      ...
      description: 'Test all outdoor GFCI outlets for safety.',
      priority: 'Medium',
      status: 'Identified',
      current_fix_cost: 0,
      cascade_risk_score: 3,
    ...
    },
    {
      id: 'unsched-10',
      property_id: 'demo-investor-2',
      title: 'Spring lawn aeration & overseed',
      description: 'Aerate and overseed lawn for healthy growth.',
      priority: 'Routine',
      status: 'Identified',
      current_fix_cost: 225,
      cascade_risk_score: 1,
      system_type: 'Landscaping',
      source: 'SEASONAL_CHECKLIST',
      contractor_cost: 225,
    ...
    },
    {
      ...
      description: 'Fix damaged mailbox doors and locks.',
      priority: 'Low',
      status: 'Identified',
    ...
    },
    {
      ...
      description: 'Annual fire extinguisher inspection required by code.',
      priority: 'High',
      status: 'Identified',
      current_fix_cost: 0,
      cascade_risk_score: 2,
    ...
    },
    {
      ...
      description: 'Tighten loose handrails for tenant safety.',
      priority: 'Medium',
      status: 'Identified',
      current_fix_cost: 150,
      cascade_risk_score: 4,
    ...
    },
    {
      id: 'unsched-15',
      property_id: 'demo-investor-3',
      title: 'Window washing - all units',
      description: 'Professional window washing service.',
      priority: 'Routine',
      status: 'Identified',
      current_fix_cost: 380,
      cascade_risk_score: 1,
      system_type: 'General',
      source: 'SEASONAL_CHECKLIST',
      scope: 'building_wide',
