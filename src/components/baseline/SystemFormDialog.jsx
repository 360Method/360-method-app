...
export default function SystemFormDialog({ open, onClose, propertyId, editingSystem, systemDescription }) {
  ...
  const toggleWarningSign = (sign) => {
    setFormData(prev => ({
      ...prev,
      warning_signs_present: prev.warning_signs_present.includes(sign)
        ? prev.warning_signs_present.filter(s => s !== sign)
        : [...prev.warning_signs_present, sign]
    }));
  };
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        ...
                        // Auto-populate typical lifespan
                        const lifespans = {
                          "asphalt_3tab": 18,
