...
import { CheckCircle2, Home, ClipboardCheck, Calendar } from "lucide-react";
import { Link } from "react-router-dom";
import { createPageUrl } from "@/utils";
import ServiceRequestDialog from "../services/ServiceRequestDialog.jsx";
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                Schedule Professional Baseline
              </Button>
      ...
      {showServiceDialog && (
        <ServiceRequestDialog
          ...
          prefilledData={{
            ...
            description: "I would like a professional to complete the baseline documentation for my property."
          }}
        />
      )}
    </>
