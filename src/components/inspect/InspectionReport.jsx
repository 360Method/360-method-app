...
import { ArrowLeft, Download, Mail, Printer, CheckCircle, AlertTriangle } from "lucide-react";

export default function InspectionReport({ inspection, property, baselineSystems, onBack }) {
        ...
        <Card className="border-none shadow-lg">
          <CardContent className="p-12 space-y-8">
            ...
            <div className="text-center border-b pb-6">
              <h1 className="text-4xl font-bold mb-2" style={{ color: '#1B365D' }}>INSPECTION REPORT</h1>
              <p className="text-2xl font-semibold text-gray-700">{inspection.season} {inspection.year} Inspection</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{inspection.created_by || 'Property Owner'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Duration:</p>
                <p className="text-lg font-semibold">{inspection.duration_minutes || 0} minutes</p>
              </div>
            </div>
            ...
            {/* Executive Summary */}
            <div>
              <h2 className="text-2xl font-bold mb-6" style={{ color: '#1B365D' }}>EXECUTIVE SUMMARY:</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <Card className={`border-2 ${
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-3xl font-bold" style={{ color: '#1B365D' }}>{overallCondition}</p>
                ...
                <Card className="border-2 border-gray-300">
                  <CardContent className="p-6">
                    ...
                    <p className="text-3xl font-bold" style={{ color: '#1B365D' }}>{allIssues.length}</p>
            ...
            {/* Findings by Area */}
            <div>
              <h2 className="text-2xl font-bold mb-6" style={{ color: '#1B365D' }}>FINDINGS BY AREA:</h2>
              ...
              <div className="space-y-6">
                ...
                {Array.from(new Set(allIssues.map(i => i.area))).map((areaName) => {
                  ...
                  return (
                    <div key={areaName}>
                      <h3 className="text-xl font-semibold mb-3" style={{ color: '#1B365D' }}>{areaName}:</h3>
                      {hasIssues ? (
            ...
            {/* Recommended Actions */}
            <div>
              <h2 className="text-2xl font-bold mb-6" style={{ color: '#1B365D' }}>RECOMMENDED ACTIONS:</h2>
              
              {urgentIssues.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-xl font-semibold mb-3 text-red-700">URGENT (This Week):</h3>
              ...
              {flagIssues.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-xl font-semibold mb-3 text-orange-700">FLAG (Next 30-90 Days):</h3>
              ...
              {monitorIssues.length > 0 && (
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-green-700">MONITOR (Next Inspection):</h3>
            ...
            {completedQuickFixes.length > 0 && (
              <>
                <hr className="border-gray-300" />
                <div>
                  <h2 className="text-2xl font-bold mb-4" style={{ color: '#1B365D' }}>MAINTENANCE COMPLETED DURING VISIT:</h2>
