...
export default function Login() {
  ...
  const { login, signup, loginWithGoogle, isAuthenticated, isLoadingAuth, authError } = useAuth();
  ...
  const handleLogin = async (e) => {
    ...
    if (result.success) {
      ...
      setMessage({
        type: 'error',
        text: result.error?.message || 'Failed to sign in. Please check your credentials.'
      });
    }
  ...
  const handleGoogleLogin = async () => {
    ...
    if (!result.success) {
      setMessage({
        type: 'error',
        text: result.error?.message || 'Failed to sign in with Google'
      });
    }
  };
